...
namespace Bakery.Controllers
{
    public class CakeCreatorsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.LevelID = new SelectList(db.Levels, "LevelID", "LevelCount");
            ...
            int lastProductId = db.CakeCreators.Max(item => item.CakeCreatorID);
            return View();
        }
        ...
        public decimal CountPrice(int id)
        {
            CakeCreator cakeCreator = db.CakeCreators.Find(id);

            decimal Price;

            Price = (decimal)cakeCreator.Accesory.Price;
            return Price;
        }
